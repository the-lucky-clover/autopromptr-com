    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24 md:pt-20 animate-fade-in">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-5xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground mb-12 leading-relaxed max-w-4xl mx-auto font-light animate-slide-up delay-200">
          ...
          {showButtons && (
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16 animate-slide-up delay-400">
              <Button 
                ...
                className="text-primary-foreground text-lg px-8 py-4 font-semibold transition-all duration-200 flex items-center justify-center gap-2 bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 hover-lift press-effect"
              >
                <span>⭐︎</span>
                Get Started
              </Button>
              <Button 
                ...
                className="bg-secondary hover:bg-secondary/80 text-secondary-foreground text-lg px-8 py-4 font-semibold transition-all duration-200 flex items-center justify-center gap-2 hover-lift press-effect"
              >
                Sign In
          ...
          <div className="mt-16 relative animate-slide-up delay-600">
            ...
            <div className="relative mx-auto max-w-xl z-10">
              ...
              {/* Main floating image */}
              <div className="anime-glassmorphism intermittent-shimmer">
                <img 
                  ...
                  className="relative mx-auto rounded-2xl shadow-2xl max-w-full h-auto"
                  onError={(e) => {
