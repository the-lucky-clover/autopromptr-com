  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
      {stats.map((stat, index) => (
        <Card key={index} className="glass-effect border-purple-500/20 hover:border-purple-500/40 transition-all duration-300">
          ...
          <CardContent>
            ...
            <div className="flex items-center text-xs">
              ...
              <span className="text-gray-400 ml-1">{stat.description}</span>
            </div>
          </CardContent>
        </Card>
      ))}
