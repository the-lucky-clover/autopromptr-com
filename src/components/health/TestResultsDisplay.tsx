...
import { TestSuite } from './HealthStatusTypes';

interface TestResultsDisplayProps {
  lastTestResults: TestSuite | null;
  isCompact?: boolean;
}

const getStatusColor = (status: string) => {
  switch (status) {
    case 'passed': return 'text-green-400 border-green-400 bg-green-400/20';
    case 'failed': return 'text-red-400 border-red-400 bg-red-400/20';
    case 'partial': return 'text-yellow-400 border-yellow-400 bg-yellow-400/20';
